...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ASAudioWaveformView/ASAudioWaveformView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RETrimControl/RETrimControl.framework"
