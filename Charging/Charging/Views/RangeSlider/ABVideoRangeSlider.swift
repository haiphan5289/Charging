...
public protocol ABVideoRangeSliderDelegate {
    ...
    func updateFrameSlide(startIndicator: CGFloat, endIndicator: CGFloat)
}
...
public class ABVideoRangeSlider: UIView {
    ...
    var startAudioPercentage: CGFloat    = 0
...
//        self.updateThumbnails()
    ...
    @objc func startDragged(recognizer: UIPanGestureRecognizer){
        ...
        self.startAudioPercentage = self.startPercentage
        ...
        self.delegate?.updateFrameSlide(startIndicator: startIndicator.frame.origin.x, endIndicator: endIndicator.frame.origin.x)
    ...
    func getDurationAudio() -> Float64 {
        return secondsFromValue(value: self.endPercentage)
    }
